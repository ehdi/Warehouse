package com.ika.warehouseinventory.exception;


import com.ika.warehouseinventory.service.vm.FieldErrorVM;
import com.ika.warehouseinventory.util.HeaderUtil;
import java.net.URI;
...
public class ExceptionTranslator implements ProblemHandling {
  ...
  public ResponseEntity<Problem> handleBadRequestAlertException(BadRequestAlertException ex,
    ...
    return create(ex, request, HeaderUtil
        .createFailureAlert(applicationName, true, ex.getEntityName(), ex.getErrorKey(),
            ex.getMessage()));
  }
  ...
  public ProblemBuilder prepare(final Throwable throwable, final StatusType status,
    ...
    if (activeProfiles.contains("pro")) {
  ...
  private boolean containsPackageName(String message) {
    ...
    return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.",
        "com.", "io.", "de.", "com.ikea.warehouse");
  }
}
